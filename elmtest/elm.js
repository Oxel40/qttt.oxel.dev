...
var $author$project$Test$update = F2(
	function (msg, model) {
		...
		var _v1 = function () {
			...
			if (_v2.$ === 'Just') {
				var s = _v2.a;
				return (!_Utils_eq(s, i)) ? _Utils_Tuple3(
					_Utils_ap(
						model.moves,
						_List_fromArray(
							[
		...
		[
			...
			_List_fromArray(
				[
					...
					$elm$svg$Svg$Attributes$strokeWidth('25'),
...
var $author$project$Test$subCell = F3(
	function (i, si, model) {
		var p = function () {
		...
		var content = function () {
			if (p.$ === 'Empty') {
				return A2(
					...
					_List_fromArray(
						[
							$elm$html$Html$Attributes$class('grow shrink max-w-3xl max-h-3xl grid grid-cols-3')
						]),
					A2(
						$elm$core$List$map,
						function (si) {
							return A3($author$project$Test$subCell, i, si, model);
						},
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('flex items-center justify-center h-screen')
					]),
				_List_fromArray(
					[
						A2(
						...
						A2(
							$elm$core$List$map,
							function (i) {
								return A2($author$project$Test$cell, i, model);
							},
							A2($elm$core$List$range, 0, 8)))
					]))
			]));
